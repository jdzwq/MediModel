/*********************************************************************************************
脚本说明：以下脚本用于分析门诊项目开展水位指标，运行时应替换实际机构代码和名称
机构编码：H00000000000
机构名称：测试医院
**********************************************************************************************/
...
(
SELECT distinct PERCENTILE_DISC(0.5) WITHIN GROUP (ORDER BY 开展率) 
...
and exists (select 1 from TMP_分位 b where a.就医方式 = b.就医方式 and a.项目名称 = b.项目名称 and a.开展率 <= b.中分位)
)t where s.就医方式 = t.就医方式 and s.项目名称 = t.项目名称);
commit;
...
--筛选高水位
delete from 线索_问题特征 where 机构编码 = 'H00000000000' and 就医来源 in ('门诊','购药') and 特征类 = '就医开展率';
commit;
...
where a.就医方式 = b.就医方式 and a.项目名称 = b.项目名称 and a.开展率 > b.低分位 + b.分位矩 * 1.5
order by 特征名,特征位;
commit;
...
select a.机构编码
    ...
    ,a.性别对象
    ,b.项目名称
    ,round(sum(b.项目次数) / count(distinct a.性别对象),2) 开展率
from 模型_门诊人群 a inner join 模型_门诊项目 b on a.机构编码 = b.机构编码 and a.就医方式 = b.就医方式  and a.身份证号 = b.身份证号 and a.门诊日期 = b.门诊日期
where a.机构编码 = 'H00000000000' and b.项目类别 not in ('西药费','成药费','草药费','材料费') 
...
SELECT distinct PERCENTILE_DISC(0.5) WITHIN GROUP (ORDER BY 开展率) 
    ...
    ,项目名称
FROM TMP_水位 a where 机构编码 = 'H00000000000'
and exists (select 1 from TMP_分位 b where a.就医方式 = b.就医方式 and a.性别对象 = b.性别对象 and a.项目名称 = b.项目名称 and a.开展率 <= b.中分位)
)t where s.就医方式 = t.就医方式 and s.性别对象 = t.性别对象 and s.项目名称 = t.项目名称);
commit;
...
--筛选高水位
delete from 线索_问题特征 where 机构编码 = 'H00000000000' and 就医来源 in ('门诊','购药') and 特征类 = '性别开展率';
commit;
...
select a.机构编码
    ...
    ,a.开展率 特征值
    ,年月 特征位 ,'高水位' 特征区 from TMP_水位 a, TMP_分位 b
where a.就医方式 = b.就医方式 and a.性别对象 = b.性别对象 and a.项目名称 = b.项目名称 and a.开展率 > b.低分位 + b.分位矩 * 1.5
order by 特征名,特征位;
commit;
...
select a.机构编码
    ...
    ,a.年龄对象
    ,b.项目名称
    ,round(sum(b.项目次数) / count(distinct a.年龄对象),2) 开展率
from 模型_门诊人群 a inner join 模型_门诊项目 b on a.机构编码 = b.机构编码 and a.就医方式 = b.就医方式  and a.身份证号 = b.身份证号 and a.门诊日期 = b.门诊日期
where a.机构编码 = 'H00000000000' and b.项目类别 not in ('西药费','成药费','草药费','材料费') 
...
SELECT distinct PERCENTILE_DISC(0.5) WITHIN GROUP (ORDER BY 开展率) 
    ...
    ,项目名称
FROM TMP_水位 a where 机构编码 = 'H00000000000'
and exists (select 1 from TMP_分位 b where a.就医方式 = b.就医方式 and a.年龄对象 = b.年龄对象 and a.项目名称 = b.项目名称 and a.开展率 <= b.中分位)
)t where s.就医方式 = t.就医方式 and s.年龄对象 = t.年龄对象 and s.项目名称 = t.项目名称);
commit;
...
--筛选高水位
delete from 线索_问题特征 where 机构编码 = 'H00000000000' and 就医来源 in ('门诊','购药') and 特征类 = '年龄开展率';
commit;
...
select a.机构编码
    ...
    ,a.开展率 特征值
    ,年月 特征位 ,'高水位' 特征区 from TMP_水位 a, TMP_分位 b
where a.就医方式 = b.就医方式 and a.年龄对象 = b.年龄对象 and a.项目名称 = b.项目名称 and a.开展率 > b.低分位 + b.分位矩 * 1.5
order by 特征名,特征位;
commit;
...
select a.机构编码
    ...
    ,a.持证类别
    ,b.项目名称
    ,round(sum(b.项目次数) / count(distinct a.持证类别),2) 开展率
from 模型_门诊人群 a inner join 模型_门诊项目 b on a.机构编码 = b.机构编码 and a.就医方式 = b.就医方式  and a.身份证号 = b.身份证号 and a.门诊日期 = b.门诊日期
where a.机构编码 = 'H00000000000' and b.项目类别 not in ('西药费','成药费','草药费','材料费') 
...
SELECT distinct PERCENTILE_DISC(0.5) WITHIN GROUP (ORDER BY 开展率) 
    ...
    ,项目名称
FROM TMP_水位 a where 机构编码 = 'H00000000000'
and exists (select 1 from TMP_分位 b where a.就医方式 = b.就医方式 and a.持证类别 = b.持证类别 and a.项目名称 = b.项目名称 and a.开展率 <= b.中分位)
)t where s.就医方式 = t.就医方式 and s.持证类别 = t.持证类别 and s.项目名称 = t.项目名称);
commit;
...
--筛选高水位
delete from 线索_问题特征 where 机构编码 = 'H00000000000' and 就医来源 in ('门诊','购药') and 特征类 = '持证开展率';
commit;
...
select a.机构编码
    ...
    ,a.开展率 特征值
    ,年月 特征位 ,'高水位' 特征区 from TMP_水位 a, TMP_分位 b
where a.就医方式 = b.就医方式 and a.持证类别 = b.持证类别 and a.项目名称 = b.项目名称 and a.开展率 > b.低分位 + b.分位矩 * 1.5
order by 特征名,特征位;
commit;
...
select a.机构编码
    ...
    ,a.参保地域
    ,b.项目名称
    ,round(sum(b.项目次数) / count(distinct a.参保地域),2) 开展率
from 模型_门诊人群 a inner join 模型_门诊项目 b on a.机构编码 = b.机构编码 and a.就医方式 = b.就医方式  and a.身份证号 = b.身份证号 and a.门诊日期 = b.门诊日期
where a.机构编码 = 'H00000000000' and b.项目类别 not in ('西药费','成药费','草药费','材料费') 
...
SELECT distinct PERCENTILE_DISC(0.5) WITHIN GROUP (ORDER BY 开展率) 
    ...
    ,项目名称
FROM TMP_水位 a where 机构编码 = 'H00000000000'
and exists (select 1 from TMP_分位 b where a.就医方式 = b.就医方式 and a.参保地域 = b.参保地域 and a.项目名称 = b.项目名称 and a.开展率 <= b.中分位)
)t where s.就医方式 = t.就医方式 and s.参保地域 = t.参保地域 and s.项目名称 = t.项目名称);
commit;
...
--筛选高水位
delete from 线索_问题特征 where 机构编码 = 'H00000000000' and 就医来源 in ('门诊','购药') and 特征类 = '地域开展率';
commit;
...
select a.机构编码
    ...
    ,a.开展率 特征值
    ,年月 特征位 ,'高水位' 特征区 from TMP_水位 a, TMP_分位 b
where a.就医方式 = b.就医方式 and a.参保地域 = b.参保地域 and a.项目名称 = b.项目名称 and a.开展率 > b.低分位 + b.分位矩 * 1.5
order by 特征名,特征位;
commit;
...
select a.机构编码
    ...
    ,a.病种名称
    ,b.项目名称
    ,round(sum(b.项目次数) / count(distinct a.病种名称),2) 开展率
from 模型_门诊人群 a inner join 模型_门诊项目 b on a.机构编码 = b.机构编码 and a.就医方式 = b.就医方式  and a.身份证号 = b.身份证号 and a.门诊日期 = b.门诊日期
where a.机构编码 = 'H00000000000' and b.项目类别 not in ('西药费','成药费','草药费','材料费') 
...
SELECT distinct PERCENTILE_DISC(0.5) WITHIN GROUP (ORDER BY 开展率) 
    ...
    ,项目名称
FROM TMP_水位 a where 机构编码 = 'H00000000000'
and exists (select 1 from TMP_分位 b where a.就医方式 = b.就医方式 and a.病种名称 = b.病种名称 and a.项目名称 = b.项目名称 and a.开展率 <= b.中分位)
)t where s.就医方式 = t.就医方式 and s.病种名称 = t.病种名称 and s.项目名称 = t.项目名称);
commit;
...
--筛选高水位
delete from 线索_问题特征 where 机构编码 = 'H00000000000' and 就医来源 in ('门诊','购药') and 特征类 = '病种开展率';
commit;
...
select a.机构编码
    ...
    ,a.开展率 特征值
    ,年月 特征位 ,'高水位' 特征区 from TMP_水位 a, TMP_分位 b
where a.就医方式 = b.就医方式 and a.病种名称 = b.病种名称 and a.项目名称 = b.项目名称 and a.开展率 > b.低分位 + b.分位矩 * 1.5
order by 特征名,特征位;
commit;
...
select a.机构编码
    ...
    ,a.专业名称
    ,b.项目名称
    ,round(sum(b.项目次数) / count(distinct a.专业名称),2) 开展率
from 模型_门诊人群 a inner join 模型_门诊项目 b on a.机构编码 = b.机构编码 and a.就医方式 = b.就医方式  and a.身份证号 = b.身份证号 and a.门诊日期 = b.门诊日期
where a.机构编码 = 'H00000000000' and b.项目类别 not in ('西药费','成药费','草药费','材料费') 
...
SELECT distinct PERCENTILE_DISC(0.5) WITHIN GROUP (ORDER BY 开展率) 
    ...
    ,项目名称
FROM TMP_水位 a where 机构编码 = 'H00000000000'
and exists (select 1 from TMP_分位 b where a.就医方式 = b.就医方式 and a.专业名称 = b.专业名称 and a.项目名称 = b.项目名称 and a.开展率 <= b.中分位)
)t where s.就医方式 = t.就医方式 and s.专业名称 = t.专业名称 and s.项目名称 = t.项目名称);
commit;
...
--筛选高水位
delete from 线索_问题特征 where 机构编码 = 'H00000000000' and 就医来源 in ('门诊','购药') and 特征类 = '专业开展率';
commit;
...
select a.机构编码
    ...
    ,a.开展率 特征值
    ,年月 特征位 ,'高水位' 特征区 from TMP_水位 a, TMP_分位 b
where a.就医方式 = b.就医方式 and a.专业名称 = b.专业名称 and a.项目名称 = b.项目名称 and a.开展率 > b.低分位 + b.分位矩 * 1.5
order by 特征名,特征位;
commit;
...
select a.机构编码
    ...
    ,a.门诊医生
    ,b.项目名称
    ,round(sum(b.项目次数) / count(distinct a.门诊医生),2) 开展率
from 模型_门诊人群 a inner join 模型_门诊项目 b on a.机构编码 = b.机构编码 and a.就医方式 = b.就医方式  and a.身份证号 = b.身份证号 and a.门诊日期 = b.门诊日期
where a.机构编码 = 'H00000000000' and b.项目类别 not in ('西药费','成药费','草药费','材料费') 
...
SELECT distinct PERCENTILE_DISC(0.5) WITHIN GROUP (ORDER BY 开展率) 
    ...
    ,项目名称
FROM TMP_水位 a where 机构编码 = 'H00000000000'
and exists (select 1 from TMP_分位 b where a.就医方式 = b.就医方式 and a.门诊医生 = b.门诊医生 and a.项目名称 = b.项目名称 and a.开展率 <= b.中分位)
)t where s.就医方式 = t.就医方式 and s.门诊医生 = t.门诊医生 and s.项目名称 = t.项目名称);
commit;
...
--筛选高水位
delete from 线索_问题特征 where 机构编码 = 'H00000000000' and 就医来源 in ('门诊','购药') and 特征类 = '医生开展率';
commit;
...
select a.机构编码
    ...
    ,a.开展率 特征值
    ,年月 特征位 ,'高水位' 特征区 from TMP_水位 a, TMP_分位 b
where a.就医方式 = b.就医方式 and a.门诊医生 = b.门诊医生 and a.项目名称 = b.项目名称 and a.开展率 > b.低分位 + b.分位矩 * 1.5
order by 特征名,特征位;
commit;
...
select a.机构编码
    ...
    ,a.门诊科室
    ,b.项目名称
    ,round(sum(b.项目次数) / count(distinct a.门诊科室),2) 开展率
from 模型_门诊人群 a inner join 模型_门诊项目 b on a.机构编码 = b.机构编码 and a.就医方式 = b.就医方式  and a.身份证号 = b.身份证号 and a.门诊日期 = b.门诊日期
where a.机构编码 = 'H00000000000' and b.项目类别 not in ('西药费','成药费','草药费','材料费') 
...
SELECT distinct PERCENTILE_DISC(0.5) WITHIN GROUP (ORDER BY 开展率) 
    ...
    ,项目名称
FROM TMP_水位 a where 机构编码 = 'H00000000000'
and exists (select 1 from TMP_分位 b where a.就医方式 = b.就医方式 and a.门诊科室 = b.门诊科室 and a.项目名称 = b.项目名称 and a.开展率 <= b.中分位)
)t where s.就医方式 = t.就医方式 and s.门诊科室 = t.门诊科室 and s.项目名称 = t.项目名称);
commit;
...
--筛选高水位
delete from 线索_问题特征 where 机构编码 = 'H00000000000' and 就医来源 in ('门诊','购药') and 特征类 = '科室开展率';
commit;
...
select a.机构编码
    ...
    ,a.开展率 特征值
    ,年月 特征位 ,'高水位' 特征区 from TMP_水位 a, TMP_分位 b
where a.就医方式 = b.就医方式 and a.门诊科室 = b.门诊科室 and a.项目名称 = b.项目名称 and a.开展率 > b.低分位 + b.分位矩 * 1.5
order by 特征名,特征位;
commit;
...
delete from 线索_问题病案 where 机构编码 = 'H00000000000' and 就医来源 in ('门诊','购药')
    and 线索来源 = '水位分析' and 问题类型 = '项目开展率异常';
commit;
