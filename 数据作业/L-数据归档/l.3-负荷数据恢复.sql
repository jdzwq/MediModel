...
--*******************************************************************************************--
--脚本：创建负荷表的数据链接
--create database link arch_link connect to arch identified by abc 
...
insert into 负荷_机构摘要
SELECT "机构编码","机构名称","所属区划","机构性质","机构等级","机构类型","核定床位","定点开始日期","定点停止日期" 
FROM "归档_机构摘要"@arch_link A where 档案编号 = 'YBZX2024' and 机构编码 = 'H00000000000';
commit;
...
insert into 负荷_门诊就医
SELECT "机构等级","机构编码","机构名称","险种类别","持证类别","参保区划","姓名","性别","年龄","身份证号","门诊号","门诊日期","门诊科室","门诊医生","疾病编码","疾病诊断","次要诊断","结算流水号","结算类别","结算日期","医疗金额","列支金额","基金支付","个账支付","现金支付"
FROM 归档_门诊就医@arch_link A where 档案编号 = 'YBZX2024' and 机构编码 = 'H00000000000';
commit;

alter index 索引_负荷_门诊就医 rebuild;
--*******************************************************************************************--
--脚本：恢复门诊结算记录
...
FROM 归档_门诊结算@arch_link A where 档案编号 = 'YBZX2024' and 机构编码 = 'H00000000000';
commit;

alter index 索引_负荷_门诊结算 rebuild;
--*******************************************************************************************--
--脚本：恢复门诊处方记录
...
FROM 归档_门诊处方@arch_link A where 档案编号 = 'YBZX2024' and 机构编码 = 'H00000000000';
commit;

alter index 索引_负荷_门诊处方 rebuild;
--*******************************************************************************************--
--脚本：恢复门诊手术记录
...
FROM 归档_门诊手术@arch_link A where 档案编号 = 'YBZX2024' and 机构编码 = 'H00000000000';
commit;

alter index 索引_负荷_门诊手术 rebuild;
--*******************************************************************************************--
--脚本：恢复门诊麻醉记录
...
FROM 归档_门诊麻醉@arch_link A where 档案编号 = 'YBZX2024' and 机构编码 = 'H00000000000';
commit;

alter index 索引_负荷_门诊麻醉 rebuild;
--*******************************************************************************************--
--脚本：恢复住院就医记录
...
insert into 负荷_住院就医
SELECT "机构等级","机构编码","机构名称","险种类别","持证类别","参保区划","姓名","性别","年龄","身份证号","住院号","入院日期","出院日期","住院天数","住院科室","住院医生","疾病编码","疾病诊断","次要诊断","结算流水号","结算类别","结算日期","医疗金额","列支金额","基金支付","个账支付","现金支付"
FROM 归档_住院就医@arch_link A where 档案编号 = 'YBZX2024' and 机构编码 = 'H00000000000';
commit;
...
FROM 归档_住院结算@arch_link A where 档案编号 = 'YBZX2024' and 机构编码 = 'H00000000000';
commit;
...
FROM 归档_住院医嘱@arch_link A where 档案编号 = 'YBZX2024' and 机构编码 = 'H00000000000';
commit;
...
FROM 归档_住院手术@arch_link A where 档案编号 = 'YBZX2024' and 机构编码 = 'H00000000000';
commit;
...
FROM 归档_住院麻醉@arch_link A where 档案编号 = 'YBZX2024' and 机构编码 = 'H00000000000';
commit;
...
FROM 归档_检查登记@arch_link A where 档案编号 = 'YBZX2024' and 机构编码 = 'H00000000000';
commit;
...
FROM 归档_检查报告@arch_link A where 档案编号 = 'YBZX2024' and 机构编码 = 'H00000000000';
commit;
...
FROM 归档_化验登记@arch_link A where 档案编号 = 'YBZX2024' and 机构编码 = 'H00000000000';
commit;
...
FROM 归档_化验报告@arch_link A where 档案编号 = 'YBZX2024' and 机构编码 = 'H00000000000';
commit;
...
FROM 归档_药库结转@arch_link A where 档案编号 = 'YBZX2024' and 机构编码 = 'H00000000000';
commit;

alter index 索引_负荷_药库结转 rebuild;
--*******************************************************************************************--
--脚本：恢复药库消耗记录
...
FROM 归档_药库消耗@arch_link A where 档案编号 = 'YBZX2024' and 机构编码 = 'H00000000000';
commit;

alter index 索引_负荷_药库消耗 rebuild;
--*******************************************************************************************--
--脚本：恢复药房结转记录
...
FROM 归档_药房结转@arch_link A where 档案编号 = 'YBZX2024' and 机构编码 = 'H00000000000';
commit;

alter index 索引_负荷_药房结转 rebuild;
--*******************************************************************************************--
--脚本：恢复药房消耗记录
...
FROM 归档_药房消耗@arch_link A where 档案编号 = 'YBZX2024' and 机构编码 = 'H00000000000';
commit;

alter index 索引_负荷_药房消耗 rebuild;
--*******************************************************************************************--