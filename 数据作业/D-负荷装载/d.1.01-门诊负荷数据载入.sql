...
SELECT trim(结算流水号) 流水号,sum(医疗金额) 医疗金额 from 测试医院_门诊就医@HOSP_LINK
...
from 测试医院_门诊就医@HOSP_LINK a inner join 测试医院_机构摘要@HOSP_LINK b on a.机构编码 = b.机构编码
...
from 测试医院_门诊结算@HOSP_LINK a
where exists (select 1 from 测试医院_机构摘要@HOSP_LINK b where a.机构编码 = b.机构编码)
