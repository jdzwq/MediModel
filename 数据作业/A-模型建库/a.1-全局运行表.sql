...
命名规则：模型_*，用于归集、模型与规则运算相关的数据项目或指标
命名规则：应用_*，用于输出问题线索
**********************************************************************************************/
...
--[诊疗次数表]******************************************************--
--说明：用于计算默认诊疗执行次数
 CREATE TABLE 字典_诊疗次数(
    项目编码 VARCHAR2(50) NULL, 
	项目名称 VARCHAR2(200) NULL, 
	国家项目编码 VARCHAR2(50) NULL, 
	国家项目名称 VARCHAR2(200) NULL, 
    项目次数 INTEGER NULL,
	项目单位 VARCHAR2(50) NULL
);
...
CREATE TABLE 字典_疾病分类(
  病种类型 VARCHAR2(50) NULL,
	病种编码 VARCHAR2(50) NULL,
	病种名称 VARCHAR2(200) NULL,
	病类编码 VARCHAR2(50) NULL,
	病类名称 VARCHAR2(200) NULL,
  专业名称 VARCHAR2(100) NULL
);
...
CREATE TABLE 字典_规则分类(
  ...
  规则用途 VARCHAR2(100) NULL,
  规则范式 VARCHAR2(100) NULL
);

--[常用药品表]******************************************************--
--说明：用于编录常用医保药品
CREATE TABLE 字典_常用药品 (
    药品编码 VARCHAR2(50) NULL, 
	药品名称 VARCHAR2(200) NULL, 
	通用名称 VARCHAR2(200) NULL, 
	剂型 VARCHAR2(200) NULL, 
	规格 VARCHAR2(500) NULL, 
	单位 VARCHAR2(50) NULL, 
...
CREATE TABLE 规则_药品限制(
  ...
  极量限制 VARCHAR2(50)  NULL,   --单次最大用量
  疗程限制 VARCHAR2(50)  NULL,   --疗程最大天数
  总额限制 VARCHAR2(50)  NULL,   --年度的额度上限
  领域标识 VARCHAR2(50) NULL
);
create index 索引_规则_药品限制 on 规则_药品限制 (药品编码);
...
create index 索引_规则_诊疗限制 on 规则_诊疗限制 (诊疗编码);

--[项目串换表]******************************************************--
--说明：用于匹配串换项目
CREATE TABLE 规则_项目串换 (
...
--[项目重复表]******************************************************--
--说明：用于匹配诊疗重复项目
CREATE TABLE 规则_项目重复 (
  主项编码 VARCHAR2(50) NULL,
	主项名称 VARCHAR2(200) NULL,   --首要、主要或套餐操作
  从项编码 VARCHAR2(500) NULL,
  从项名称 VARCHAR2(1000) NULL,   --属于主项操作的小类、部分或子项操作
  来源标识 VARCHAR2(50) NULL,
  领域标识 VARCHAR2(50) NULL
);
...
--[项目组合表]******************************************************--
--说明：用于匹配组合项目
CREATE TABLE 规则_项目组合 (
  主项编码 VARCHAR2(50) NULL,
	主项名称 VARCHAR2(200) NULL,   --首要或主要操作
  子项编码 VARCHAR2(500) NULL,
  子项名称 VARCHAR2(1000) NULL, 
  来源标识 VARCHAR2(50) NULL,
  领域标识 VARCHAR2(50) NULL
);
...
CREATE INDEX 索引_负荷_机构摘要 ON 负荷_机构摘要 (机构编码);
...
CREATE INDEX 索引_负荷_门诊就医 ON 负荷_门诊就医 (机构编码, 门诊号);
...
CREATE INDEX 索引_负荷_门诊结算 ON 负荷_门诊结算 (机构编码, 门诊号);
CREATE INDEX 索引_负荷_门诊结算_国标代码 ON 负荷_门诊结算 (国标代码);
...
CREATE INDEX 索引_负荷_门诊处方 ON 负荷_门诊处方 (机构编码, 门诊号);
...
CREATE INDEX 索引_负荷_门诊手术 ON 负荷_门诊手术 (机构编码, 门诊号);
...
CREATE INDEX 索引_负荷_门诊麻醉 ON 负荷_门诊麻醉 (机构编码, 门诊号);
...
CREATE INDEX 索引_负荷_住院就医 ON 负荷_住院就医 (机构编码, 住院号);
...
CREATE INDEX 索引_负荷_住院结算 ON 负荷_住院结算 (机构编码, 住院号);
CREATE INDEX 索引_负荷_住院结算_国标代码 ON 负荷_住院结算 (国标代码);
...
CREATE INDEX 索引_负荷_住院医嘱 ON 负荷_住院医嘱 (机构编码, 住院号);
...
CREATE INDEX 索引_负荷_住院手术 ON 负荷_住院手术 (机构编码, 住院号);
...
CREATE INDEX 索引_负荷_住院麻醉 ON 负荷_住院麻醉 (机构编码, 住院号);
...
CREATE INDEX 索引_负荷_检查登记 ON 负荷_检查登记 (机构编码, 就医号);
...
CREATE INDEX 索引_负荷_检查报告 ON 负荷_检查报告 (机构编码, 就医号);
...
CREATE INDEX 索引_负荷_化验登记 ON 负荷_化验登记 (机构编码, 就医号);
...
CREATE INDEX 索引_负荷_化验报告 ON 负荷_化验报告 (机构编码, 就医号);
...
CREATE INDEX 索引_负荷_药库结转 ON 负荷_药库结转 (机构编码, 项目代码);
...
CREATE INDEX 索引_负荷_药库消耗 ON 负荷_药库消耗 (机构编码, 项目代码);
...
CREATE INDEX 索引_负荷_药房结转 ON 负荷_药房结转 (机构编码, 项目代码);
...
CREATE INDEX 索引_负荷_药房消耗 ON 负荷_药房消耗 (机构编码, 项目代码);
...
--[门诊日期校正表]******************************************************--
--说明：用于校正门诊日期
CREATE TABLE 模型_门诊日期 (
  机构编码 VARCHAR2(50) NULL,
  机构名称 VARCHAR2(100) NULL,
  身份证号 VARCHAR2(50) NULL,
  就医年度 VARCHAR2(50) NULL,
  校正天数 INTEGER NULL
);
CREATE INDEX 索引_模型_门诊日期 ON 模型_门诊日期 (机构编码, 身份证号, 就医年度);

--[门诊诊次表]******************************************************--
--说明：用于归集诊次门诊费用总额
CREATE TABLE 模型_门诊诊次 (
  机构等级 VARCHAR2(50) NULL,
  机构编码 VARCHAR2(50) NULL,
  机构名称 VARCHAR2(100) NULL,
  姓名 VARCHAR2(50) NULL,
  ...
  身份证号 VARCHAR2(50) NULL,
  险种类别 VARCHAR2(50) NULL,
  持证类别 VARCHAR2(50) NULL,
  门诊日期 DATE NULL,
  门诊天数 INTEGER NULL,
  门诊科室 VARCHAR2(2000) NULL,
  门诊医生 VARCHAR2(2000) NULL,
...
CREATE INDEX 索引_模型_门诊诊次 ON 模型_门诊诊次 (机构编码, 身份证号, 门诊日期);

--[门诊频度表]******************************************************--
--说明：用于归集诊次门诊项目费用
CREATE TABLE 模型_门诊频度(
...
CREATE INDEX 索引_模型_门诊频度 ON 模型_门诊频度 (机构编码, 身份证号, 门诊日期);
CREATE INDEX 索引_模型_门诊频度_类别代码 ON 模型_门诊频度 (类别, 代码);

--[门诊结构表]******************************************************--
--说明：用于归集门诊费用结构
CREATE TABLE 模型_门诊结构(
  机构编码 VARCHAR2(50) NULL,
  机构名称 VARCHAR2(100) NULL,
  人员姓名 VARCHAR2(50) NULL,
  身份证号 VARCHAR2(50) NULL,
...
CREATE INDEX 索引_模型_门诊结构 ON 模型_门诊结构 (机构编码, 身份证号, 门诊日期);

--[门诊人群表]******************************************************--
--说明：用于归集就医人群
CREATE TABLE 模型_门诊人群 (
  机构编码 VARCHAR2(50) NULL,
  机构名称 VARCHAR2(100) NULL,
  人员姓名 VARCHAR2(50) NULL,
  性别对象 VARCHAR2(50) NULL,
  年龄对象 VARCHAR2(50) NULL,
  身份证号 VARCHAR2(50) NULL,
  险种类别 VARCHAR2(50) NULL,
  持证类别 VARCHAR2(50) NULL,
  参保地域 VARCHAR2(50) NULL,
  就医方式 VARCHAR2(50) NULL,
  门诊日期 DATE NULL,
  门诊天数 INTEGER NULL,
  门诊科室 VARCHAR2(100) NULL,
  门诊医生 VARCHAR2(100) NULL,
  疾病编码 VARCHAR2(500) NULL,
  疾病诊断 VARCHAR2(1000) NULL,
  病种编码 VARCHAR2(50) NULL,
  病种名称 VARCHAR2(100) NULL,
  专业名称 VARCHAR2(100) NULL,
  医疗金额 NUMERIC(18,2)
);
CREATE INDEX 索引_模型_门诊人群 ON 模型_门诊人群 (机构编码, 身份证号, 门诊日期);

--[门诊项目表]******************************************************--
--说明：用于归集诊疗项目
CREATE TABLE 模型_门诊项目 (
  机构编码 VARCHAR2(50) NULL,
  身份证号 VARCHAR2(50) NULL,
  就医方式 VARCHAR2(50) NULL,
  门诊日期 DATE NULL,
  ...
  项目编码 VARCHAR2(50) NULL,
  项目名称 VARCHAR2(200) NULL,
  项目类别 VARCHAR2(50) NULL,
  项目属性 VARCHAR2(100) NULL,
  项目次数 INTEGER NULL,
  项目数量 INTEGER NULL,
  项目金额 NUMERIC(18,2)
);
CREATE INDEX 索引_模型_门诊项目 ON 模型_门诊项目 (机构编码, 就医方式, 身份证号, 门诊日期);

--[住院日期校正表]******************************************************--
--说明：用于校正住院日期
CREATE TABLE 模型_住院日期 (
  机构编码 VARCHAR2(50) NULL,
  机构名称 VARCHAR2(100) NULL,
  身份证号 VARCHAR2(50) NULL,
  就医年度 VARCHAR2(50) NULL,
...
CREATE INDEX 索引_模型_住院日期 ON 模型_住院日期 (机构编码, 身份证号, 就医年度);

--[住院诊次表]******************************************************--
--说明：用于归集诊次住院费用总额
CREATE TABLE 模型_住院诊次 (
  机构等级 VARCHAR2(50) NULL,
  机构编码 VARCHAR2(50) NULL,
  机构名称 VARCHAR2(100) NULL,
  姓名 VARCHAR2(50) NULL,
  ...
  住院日期 DATE NULL,
  住院天数 INTEGER NULL,
  住院科室 VARCHAR2(2000) NULL,
  住院医生 VARCHAR2(2000) NULL,
  疾病诊断 VARCHAR2(2000) NULL,
  次要诊断 VARCHAR2(2000) NULL,
  医疗人次 INTEGER NULL,
  医疗金额 NUMERIC(18,2) NULL,
...
CREATE INDEX 索引_模型_住院诊次 ON 模型_住院诊次 (机构编码, 身份证号, 住院日期);


--[住院频度表]******************************************************--
--说明：用于归集住院诊次项目费用
CREATE TABLE 模型_住院频度(
  机构编码 VARCHAR2(50) NOT NULL,
  机构名称 VARCHAR2(100) NULL,
  人员姓名 VARCHAR2(50) NULL,
  身份证号 VARCHAR2(50) NULL,
...
CREATE INDEX 索引_模型_住院频度 ON 模型_住院频度 (机构编码, 身份证号, 住院日期);
CREATE INDEX 索引_模型_住院频度_类别代码 ON 模型_住院频度 (类别, 代码);

--[住院结构表]******************************************************--
--说明：用于归集住院费用结构
CREATE TABLE 模型_住院结构(
  机构编码 VARCHAR2(50) NULL,
  机构名称 VARCHAR2(100) NULL,
  人员姓名 VARCHAR2(50) NULL,
  身份证号 VARCHAR2(50) NULL,
...
CREATE INDEX 索引_模型_住院结构 ON 模型_住院结构 (机构编码, 身份证号, 住院日期);

--[住院人群表]******************************************************--
--说明：用于归集就医人群
CREATE TABLE 模型_住院人群 (
  机构编码 VARCHAR2(50) NULL,
  机构名称 VARCHAR2(100) NULL,
  人员姓名 VARCHAR2(50) NULL,
  性别对象 VARCHAR2(50) NULL,
...
CREATE INDEX 索引_模型_住院人群 ON 模型_住院人群 (机构编码, 身份证号, 住院日期);

--[住院项目表]******************************************************--
--说明：用于归集诊疗项目
CREATE TABLE 模型_住院项目 (
  机构编码 VARCHAR2(50) NULL,
  身份证号 VARCHAR2(50) NULL,
  就医方式 VARCHAR2(50) NULL,
  住院日期 DATE NULL,
...
CREATE INDEX 索引_模型_住院项目 ON 模型_住院项目 (机构编码, 就医方式, 身份证号, 住院日期);

--[库房进销表]******************************************************--
--说明：用于归集药库、药房进销数据
CREATE TABLE 模型_库房进销(
  机构编码 VARCHAR2(50) NOT NULL,
  机构名称 VARCHAR2(100) NULL,
  ...
  库存数量 NUMERIC(18, 2) NULL,
  库存金额 NUMERIC(18, 2) NULL,
  库存均价 NUMERIC(18, 2) NULL,
  库存单位 VARCHAR2(50) NULL
);
CREATE INDEX 索引_模型_库房进销 ON 模型_库房进销 (机构编码, 代码);

--[库房频度表]******************************************************--
--说明：用于归集库房物资消耗频度
CREATE TABLE 模型_库房频度(
  机构编码 VARCHAR2(50) NOT NULL,
  机构名称 VARCHAR2(100) NULL,
  就医来源 VARCHAR2(50) NULL,
  部门科室 VARCHAR2(50) NULL,
  人员姓名 VARCHAR2(50) NULL,
  身份证号 VARCHAR2(50) NULL,
  业务期间 VARCHAR2(50) NULL,
  代码 VARCHAR2(50) NULL,
...
CREATE INDEX 索引_模型_库房频度 ON 模型_库房频度 (机构编码, 业务期间, 代码);
...
--[问题特征表]******************************************************--
--说明：用于归集问题特征
CREATE TABLE 线索_问题特征 (
  机构编码 VARCHAR2(50) NULL,
  就医来源 VARCHAR2(50) NULL,
  对象来源 VARCHAR2(200) NULL,
  特征类 VARCHAR2(50) NULL,
  特征名 VARCHAR2(50) NULL,
  特征值 NUMERIC(18,2) NULL,
  特征位 VARCHAR2(50) NULL,
  特征区 VARCHAR2(50) NULL
);
CREATE INDEX 索引_线索_问题特征 ON 线索_问题特征 (机构编码, 就医来源, 特征类);
...
CREATE TABLE 线索_问题项目(
  ...
  机构编码 VARCHAR2(50) NULL,
  机构名称 VARCHAR2(100) NULL,
  科室名称 VARCHAR2(2000) NULL,
  医生姓名 VARCHAR2(2000) NULL,
  身份证号 VARCHAR2(50) NULL,
  姓名 VARCHAR2(50) NULL,
  性别 VARCHAR2(50) NULL,
  年龄 VARCHAR2(50) NULL,
...
CREATE INDEX 索引_线索_问题项目 ON 线索_问题项目 (机构编码, 线索来源, 问题类型);

--[病案遴选表]******************************************************--
--说明：用于遴选问题项目的病案
--就医来源：['门诊','住院',...]
CREATE TABLE 线索_问题病案(
    就医来源 VARCHAR2(50) NULL,
    线索来源 VARCHAR2(100) NULL,
    问题类型 VARCHAR2(50) NULL,
    问题情形 VARCHAR2(4000) NULL,
    问题次数 INTEGER NULL,
    机构编码 VARCHAR2(50) NULL,
    机构名称 VARCHAR2(100) NULL,
    科室名称 VARCHAR2(2000) NULL,
...
CREATE INDEX 索引_线索_问题病案 ON 线索_问题病案 (机构编码, 线索来源, 问题类型);
