...
select '住院' 就医来源,
    ...
    g.数量 问题数量, 
    g.列支 问题金额,
    g.机构编码, g.机构名称, g.住院科室, g.住院医生, g.身份证号, g.姓名, g.性别, g.年龄, g.住院日期, g.住院天数, g.疾病诊断,
    g.类别, g.代码, g.名称, g.规格, g.单位, g.单价, g.人次, g.天数, g.频次, g.剂量, g.数量, g.金额, g.列支, g.日期
from 临时_住院药品 g  inner join 统计_库房进销 t on g.机构编码 = t.机构编码 and g.代码 = t.国标 and g.单价 > t.购入均价 * 1.5
...
select '住院' 就医来源,
    ...
    g.机构编码, g.机构名称, g.住院科室, g.住院医生, g.身份证号, g.姓名, g.性别, g.年龄, g.住院日期, g.住院天数, g.疾病诊断,
    g.类别, g.代码, g.名称, g.规格, g.单位, g.单价, g.人次, g.天数, g.频次, g.剂量, g.数量, g.金额, g.列支, g.日期
from 临时_住院材料 g  inner join 统计_库房进销 t on g.机构编码 = t.机构编码 and g.代码 = t.国标 and g.单价 > t.购入均价 * 1.25
order by 住院科室,身份证号,住院日期,名称;
commit;
--*******************************************************************************************--
