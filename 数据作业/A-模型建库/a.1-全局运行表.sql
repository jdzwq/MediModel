...
CREATE INDEX 负荷_负荷_药房结转 ON 负荷_药房结转 (机构编码, 项目代码);
...
CREATE INDEX 索引_统计_门诊诊次 ON 统计_门诊诊次 (机构编码, 身份证号, 门诊日期);
...
CREATE INDEX 索引_统计_门诊频度 ON 统计_门诊频度 (机构编码, 身份证号, 门诊日期);
CREATE INDEX 统计_门诊频度_类别代码 ON 统计_门诊频度 (类别, 代码);
...
CREATE INDEX 索引_统计_门诊结构 ON 统计_门诊结构 (机构编码, 身份证号, 门诊日期);
...
CREATE INDEX 索引_统计_住院诊次 ON 统计_住院诊次 (机构编码, 身份证号, 住院日期);
...
CREATE INDEX 索引_统计_住院频度 ON 统计_住院频度 (机构编码, 身份证号, 住院日期);
CREATE INDEX 索引_统计_住院频度_类别代码 ON 统计_住院频度 (类别, 代码);
...
CREATE INDEX 索引_统计_住院结构 ON 统计_住院结构 (机构编码, 身份证号, 住院日期);
...
CREATE INDEX 索引_统计_库房进销 ON 统计_库房进销 (机构编码, 代码);
...
CREATE INDEX 索引_应用_问题线索 ON 应用_问题线索 (机构编码, 线索来源, 问题类型);
...
CREATE INDEX 索引_应用_病案遴选 ON 应用_病案遴选 (机构编码);
