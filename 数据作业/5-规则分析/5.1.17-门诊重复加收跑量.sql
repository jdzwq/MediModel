/*********************************************************************************************
脚本说明：以下脚本用于跑测门诊重复加收规则，运行时应替换实际机构代码和名称
机构编码：H00000000000
机构名称：测试医院
...
from 临时_门诊诊疗 g inner join 规则_诊疗加收 t on upper(g.代码) like t.从项编码 || '%'
...
select '门诊' 就医来源,
    ...
    机构编码,机构名称,门诊科室,门诊医生,身份证号,姓名,性别,年龄,门诊日期,门诊天数,疾病诊断,
    类别, 代码, 名称, 规格, 单位, 单价, 人次, 天数, 频次, 剂量, 数量, 金额, 列支, 日期
from 临时_门诊诊疗 g inner join 规则_诊疗加收 t on upper(g.代码) like t.从项编码 || '%' and g.数量 > t.加收限制
