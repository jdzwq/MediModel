...
--[机构药房库存表]******************************************************--
--用途说明：用于从CSV文件或外部数据源导入机构药房库存记录
--处方分类：['单轨制','双轨制'] 
 CREATE TABLE 测试医院_药房库存 (
	机构编码 VARCHAR2(50) NULL, 
	机构名称 VARCHAR2(100) NULL, 
	药房名称 VARCHAR2(100) NULL, 
	项目代码 VARCHAR2(50) NULL, 
    ...
    生产批号 VARCHAR2(100) NULL, 
	库存单位 VARCHAR2(50) NULL, 
	库存数量 NUMBER(18,2) NULL, 
	购入价 NUMBER(18,2) NULL, 
	零售价 NUMBER(18,2) NULL, 
    通用名称 VARCHAR2(100) NULL,
    处方分类 VARCHAR2(100) NULL,
    省采药品 VARCHAR2(50) NULL, 
    国谈药品 VARCHAR2(50) NULL
);
